package com.example.diffutildemo.diffutils.sortedlist;
...
public class SortedListCallback extends SortedListAdapterCallback<TestSortBean> {
    /**
     * Creates a {@link androidx.recyclerview.widget.SortedList.Callback} that will forward data change events to the provided
     * Adapter.
     *
     * @param adapter The Adapter instance which should receive events from the SortedList.
     */
    public SortedListCallback(SortedAdapter adapter) {
        super(adapter);
    }
